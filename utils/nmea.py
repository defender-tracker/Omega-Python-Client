...
class GNSS_Blob:
	...
	def get_base_information(self):
		...
		minimal = {}
		try:
			minimal['t'] = get_epoch_time(i["fix"]["timestamp"], i["transit_data"]["datestamp"])
			minimal['lon'] = convert_lat_long(i["fix"]["lat"], i["fix"]["lat_dir"])
			minimal['lat'] = convert_lat_long(i["fix"]["lon"], i["fix"]["lon_dir"])
