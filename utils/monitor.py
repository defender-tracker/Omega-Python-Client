...
class UpdateMonitor():
    ...
    def __init__(self, sampling_distance = 200, update_callback = None):
    ...
    def _reset(self):
        ...
        self._cum_delta = 0
        self._wait = False
        self._pause_distance = 0.5
        self._resume_distance = 2
        
        self._indexer = 0
        self._moving_average_length = 10
        self._last_n_points = []
    ...
    def _distance_from_last(self, lat, lon):
        ...
        a = sin(dlat / 2)**2 + cos(next_lat) * cos(self._prev_lat) * sin(dlon / 2)**2
